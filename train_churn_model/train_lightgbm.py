...
val_data = lgb.Dataset(X_validation, label=y_validation, reference=train_data)
...
y_pred_proba_val = model_train.predict(X_validation, num_iteration=model_train.best_iteration)
...
train_combined_data = lgb.Dataset(X_train_combined, label=y_train_combined)
test_data = lgb.Dataset(X_test, label=y_test, reference=train_combined_data)
...
y_pred_proba_test = final_model.predict(X_test, num_iteration=final_model.best_iteration)
